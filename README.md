...
Entender os diferentes tipos de ameaças como códigos maliciosos e engenharia social.

Aprender a se proteger das ameaças e como evitá-las.
...
No link do NIST podemos encontrar boas práticas de segurança da informação e gerenciamento de riscos.

CERT.BR: https://cartilha.cert.br/  
No link da CERT.br pode-se encontrar a cartilha que nos orienta com boas práticas em segurança da informação, e nos orienta contra ataques e prevenção de riscos.

CISCO Networking Academy: https://www.netacad.com  
Nesse link podemos encontrar um material introdutório de redes e segurança.
...
Observação: A resposta foi muito boa, porém sem exemplos que poderiam melhorar a forma de entender.

Prompt 2: Quais são os sinais comuns de golpes na internet? Cite exemplos hipotéticos de como isso pode ocorrer na vida real.

Resultado: A resposta gerada foi bem explicativa, detalhou a explicação com exemplos de situações da nossa vida real.

Observação: Quando pedimos para a IA dar exemplos do cotidiano, ela nos entrega um material muito melhor, pois conseguimos ter maior proveito.

Prompt 3: Como evitar esses tipos de golpes? Explique com exemplos do dia a dia.

Resultado: O resultado gerado nos deu vários métodos de como nos proteger e ficar em alerta com esses tipos de fraudes. Os exemplos que recebemos também foram bem úteis, como, por exemplo, ficarmos mais atentos a e-mails falsos ou páginas na web que não contêm criptografia.

Prompt 4: Quais são os riscos de segurança em redes Wi-Fi públicas?

Resultado: A resposta gerada não foi totalmente correta sobre o assunto, já que a IA não conseguiu achar muito sobre redes Wi-Fi, pois as fontes não apresentam uma lista exaustiva dedicada especificamente a redes Wi-Fi. Mas apresentou as principais ameaças associadas ao uso de redes públicas e não confiáveis.

Prompt 5: Quais os pilares da tríade CIA? Explique de forma clara e resumida.
...
Solicitar exemplos do dia a dia nos dá um entendimento melhor sobre o assunto.

Percebi que, se usamos mais fontes, conseguimos gerar respostas mais amplas em certas partes.
...
✅ Integridade  
A integridade garante que a informação não pode ser modificada por alguém sem autorização.
Exemplos:
...
🌐 Disponibilidade  
A disponibilidade garante que a informação ou sistema esteja sempre acessível.
Exemplos:
